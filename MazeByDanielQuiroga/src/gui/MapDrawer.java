		...
		for (int y = minY; y <= maxY; y++)
			for (int x = minX; x <= maxX; x++) {
				...
				if(seenCells.hasWall(x,y, CardinalDirection.North)){
					panel.setColor(255, 255, 255);
					//panel.setColor(128, 128, 128);
				}
				else {
					panel.setColor(128, 128, 128);
					//panel.setColor(255, 255, 255);
				}
				//panel.setColor(seenCells.hasWall(x,y, CardinalDirection.North) ? (255, 255, 255) : (128, 128, 128));
				...
				//panel.setColor(seenCells.hasWall(x,y, CardinalDirection.West) ? "white" : "gray");
