...
public class StateWinning extends DefaultState {
    ...
    public void start(Controller controller, MazePanel panel) {
        ...
        view.redrawFinish(panel , this.pathLength, this.batLevUsed); // TODO THIS IS WHERE STATEWINNING CALLS ON MAZEVIEW FOR FINAL SCREEN 
    ...
    @Override
    public void setEnergy(float batteryLevelUsed) {
    	this.batLevUsed = batteryLevelUsed;
    }
}
